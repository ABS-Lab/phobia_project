...
scatter(ranef(mm3)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Src to arousal (cor=$(get_trunc(mm3coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ 4100e32b-4b8d-4e02-8f3f-d994169a8c51
scatter( df2_subjlvl_hp.social_phobia,ranef(mm3)[1][1,:], label="participant", title="Src to arousal (cor=$(get_trunc(mm3coef_i)))", ylabel="SCR cluster mean centering MLM raneff Intercept", xlabel="social Phobia")

# ╔═╡ c7d2bc63-47b4-45c6-aa5c-c1c890c4f502
scatter(ranef(mm3)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Src to arousal (cor=$(get_trunc(mm3coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mm4)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Arousal to Fear (cor=$(get_trunc(mm4coef_i)))", xlabel="Arousal cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ 7946b928-1d29-43e9-8315-871b63bd49c5
scatter(ranef(mm4)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Arousal to Fear (cor=$(get_trunc(mm4coef_w)))", xlabel="Arousal cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mm6)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr to fear (cor=$(get_trunc(mm6coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ a4e8582c-9f88-4c61-8f86-120930344057
scatter(ranef(mm6)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr to fear (cor=$(get_trunc(mm6coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mm12)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Src to valence (cor=$(get_trunc(mm12coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ a4ebcb4a-8f79-44b7-9984-c7213f606f0f
scatter(ranef(mm12)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Src to valence (cor=$(get_trunc(mm12coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mm5)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr change to arousal (cor=$(get_trunc(mm5coef_i)))", xlabel="SCR change cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ 47f40223-b93f-406a-9b38-494ff469c72c
scatter(ranef(mm5)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr change to arousal (cor=$(get_trunc(mm5coef_w)))", xlabel="SCR change cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mm7)[1][1,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr change to fear (cor=$(get_trunc(mm7coef_i)))", xlabel="SCR change cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ fe1dff56-5ab2-4b1b-9014-d4524ac536f4
scatter(ranef(mm7)[1][2,:], df2_subjlvl_hp.social_phobia, label="participant", title="Scr change to fear (cor=$(get_trunc(mm7coef_w)))", xlabel="SCR change cluster mean centering MLM raneff Weight", ylabel="social Phobia")

# ╔═╡ a9e46b0a-3c7d-4c23-a903-d17062429086
md"#### Scr to Arousal with social phobia modulating term"
...
mm14 = fit(LinearMixedModel, @formula(resp_fear ~ social_phobia * video_scr_cmc * video_hp_cmc * resp_arousal_cmc * resp_valence_cmc + video_scr_mean + video_hp_mean + resp_arousal_mean + resp_valence_mean + (video_scr_cmc * video_hp_cmc * resp_arousal_cmc * resp_valence_cmc|participant_num_str)), dfcleancol2)
...
scatter(ranef(mmz1)[1][1,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz1coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ fd2ea288-a9d4-4905-879a-0608b69c806c
scatter(ranef(mmz1)[1][2,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz1coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mmz2)[1][1,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz2coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ 52bd6b4a-7d0d-4a88-965b-d805b703c539
scatter(ranef(mmz2)[1][2,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz2coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
...
scatter(ranef(mmz3)[1][1,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz3coef_i)))", xlabel="SCR cluster mean centering MLM raneff Intercept", ylabel="social Phobia")

# ╔═╡ 729fe2cc-42ae-449c-8626-37b486fd77fe
scatter(ranef(mmz3)[1][2,:], hparr, label="participant", title="Src to arousal (cor=$(get_trunc(mmz3coef_w)))", xlabel="SCR cluster mean centering MLM raneff Weight", ylabel="social Phobia")
